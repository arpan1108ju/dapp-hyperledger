...
peer lifecycle chaincode package basic.tar.gz --path /mnt/d/Projects-D/hyperledger-fabric/fabric-samples/asset-transfer-basic/chaincode-javascript --lang node --label basic_1.0
